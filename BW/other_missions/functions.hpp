...
class other_missions_init {
    file = "BW\other_missions\fnc\init";
...
class other_missions_utils {
    file = "BW\other_missions\fnc\utils";
...
class other_missions_rescue_intel {
    file = "BW\other_missions\fnc\rescue_intel";
...
class other_missions_liberation {
    file = "BW\other_missions\fnc\liberation";
