...
200,
[1000,1000,0]
] execVM "BW\other_missions\mission_12\mission_1.sqf";
...
if (_bilding_from_mission_general isEqualTo []) exitWith {
    ["BW_liberation_missionEnd", ["BW_other_missions_rescueHostage", "ERROR", "No matching buildings found!"]] call CBA_fnc_serverEvent;
};


["Task_12", true, ["Capture or kill enemy officer","Capture or kill enemy officer","respawn_west"], _pos_mission, "CREATED", 5, true, true, "kill", true] call BIS_fnc_setTask;
...
["BW_liberation_missionEnd", ["BW_other_missions_killGeneral", "FAILED", _penalty]] call CBA_fnc_serverEvent;
...
["BW_liberation_missionEnd", ["BW_other_missions_killGeneral", "SUCCEEDED", _rewards]] call CBA_fnc_serverEvent;
