...
"CPC_ME_O_KAM_soldier_AA",
"CPC_ME_O_KAM_soldier_AA",
"CPC_ME_O_KAM_soldier_AA"]] execVM "SPEC\other_missions\mission_4\mission_1.sqf";
...
private _crater1 = "CraterLong" createVehicle (getPos dron_down);
_crater1 setPos(getPos dron_down);
//marker
