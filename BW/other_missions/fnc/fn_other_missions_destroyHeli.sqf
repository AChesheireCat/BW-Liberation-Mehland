...
// done example
// [[200,200,0],"rhsgref_cdf_Mi24D_early",EAST,1500] execVM "BW\other_missions\mission_2\mission_1.sqf";
...
//mission
["Task_02", true, ["Destroy enemy helicopter","Destroy enemy helicopter","respawn_west"], getPos(_Heli_1 select 0), "ASSIGNED", 5, true, true, "target", true] call BIS_fnc_setTask;
//patrol
...
["BW_liberation_missionEnd", ["BW_other_missions_destroyHeli", "SUCCEEDED", _rewards]] call CBA_fnc_serverEvent;
