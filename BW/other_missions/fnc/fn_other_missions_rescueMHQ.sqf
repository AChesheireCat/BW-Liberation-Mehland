...
// done example
// [[200,200,0],"rhsusf_m1152_sicps_usarmy_d",["rhsusf_m1025_d_m2", "rhsusf_M1117_D", "rhsusf_m113d_usarmy"],[1000,1000,0]] execVM "BW\other_missions\mission_5\mission_1.sqf";
...
//task
["Task_05", true, ["Rescue and return Mobile HQ Truck to FOB","Rescue and return Mobile HQ Truck to FOB","respawn_west"], getMarkerPos _Marker5, "CREATED", 5, true, true, "car", true] call BIS_fnc_setTask;

//wait prp on base or destroyed
waitUntil{
sleep 10;
...
if(!alive _Vehicle_1) exitwith {
    ...
    ["BW_liberation_missionEnd", ["BW_other_missions_rescueMHQ", "FAILED", _penalty]] call CBA_fnc_serverEvent;
...
["BW_liberation_missionEnd", ["BW_other_missions_rescueMHQ", "SUCCEEDED", _rewards]] call CBA_fnc_serverEvent;
