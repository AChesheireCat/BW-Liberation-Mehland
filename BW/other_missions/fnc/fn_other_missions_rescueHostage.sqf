...
,200] execVM "BW\other_missions\mission_11\mission_1.sqf";
...
["Task_11", true, ["Rescue Hostages","Rescue Hostages","respawn_west"], _pos_mission, "CREATED", 5, true, true, "meet", true] call BIS_fnc_setTask;
...
if(!alive _unit_1_zaloznic)exitWith{
    ...
    ["BW_liberation_missionEnd", ["BW_other_missions_rescueHostage", "FAILED", _penalty]] call CBA_fnc_serverEvent;
...
["BW_liberation_missionEnd", ["BW_other_missions_rescueHostage", "SUCCEEDED", _rewards]] call CBA_fnc_serverEvent;
